...
import { GetOrdersOnlineResType, GuestOnlineCreateOrdersBodyType, GuestOnlineCreateOrdersResType } from "@/schemaValidations/onlineGuest.schema";
...
const guestOnlineApiRequest = {
    ...
    getOrderList: () => http.get<GetOrdersOnlineResType>('/online/orders')
};
